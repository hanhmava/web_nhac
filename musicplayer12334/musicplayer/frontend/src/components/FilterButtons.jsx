...
const FilterButtons = ({ filterData, flag }) => {
  ...
  return (
    <div className="border rounded-md px-4 py-1 relative cursor-pointer hover:border-black">
      <p
        className="text-base tracking-wide text-cyan-600 flex items-center gap-2 "
