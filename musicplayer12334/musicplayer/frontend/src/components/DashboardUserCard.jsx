...
const DashboardUserCard = ({ data, index }) => {
  ...
  return (
    ...
    >
      {/* Kiểm tra nếu đây không phải là người dùng hiện tại, thì mới có thể xóa */}
      {data && (
        <motion.div
          whileTap={{ scale: 0.75 }}
      ...
      <div className="w-275 min-w-[160px] flex items-center justify-center">
        {/* Ảnh người dùng */}
        <img
          src={data?.imageURL||"https://tse1.mm.bing.net/th?id=OIP.bW-lmEx0rsWY_i9gwtsuegHaHa&pid=Api&P=0&h=180"}
          alt="User Image"
      ...
      <div className="w-275 min-w-[160px] text-center flex items-center justify-center gap-6 relative">
        ...
        {/* Hiển thị dialog khi muốn thay đổi vai trò */}
        {isUpdateRole && (
          <motion.div
          ...
          >
            <p className="text-textColor text-sm font-semibold">
              Bạn chắc chắn muốn thay đổi quyền {" "}
